...
import med.voll.api.domain.medico.DadosListagemMedido;
...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemMedido>> listar(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacao){
        var page = repository.findAllByAtivoTrue(paginacao).map(DadosListagemMedido::new);
